...
com <- rbind(
  ...
  nut %>% 
    ...
    select(admin1pcode, admin2pcode, admin3pcode, admin4pcode, 
           ...
           activity, beneficiaries, 
           month, project_status = status, cluster, 
           delivery_modality),
  ...
  erl %>% 
    mutate(month = str_sub(implementing_month, start = 5L, end = 7L), 
           ...
           admin5pcode = NA_character_) %>% 
    select(admin1pcode, admin2pcode, admin3pcode, admin4pcode, 
           admin5pcode, camp_name = other_place_name, 
           activity = sector_activity, beneficiaries, 
           month, project_status = status, cluster, 
           delivery_modality)
)
...
The total number of unique indi
