---
title: "Intercluster coverage and gaps review"
...
A more multisectoral perspective is offered in the section [Multisector programming](https://northwest-syria-cash-working-group.github.io/intercluster_4Ws_review/#multisector-programming). 
...
* Use the reference dataset provided [here](https://raw.githubusercontent.com/northwest-syria-cash-working-group/intercluster_4Ws_review/main/data/benficiaries_by_communities.csv){target="_blank"} to be more considered in your programming. Intentionally seek areas that are under-allocated. When using the link, *Ctrl + A* and *Crtl + C* and *Ctrl + V* into the spreadsheet. 
